...
contract Twap {
    ...
    function second1HourSnapShot() public returns (uint224 oneHourTwap) {
        ...
        uint256 lookback = second1HourSnapShot_TimeStamp - first1HourSnapShot_TimeStamp;
        uint256 pricep = second1HourSnapShot_Price0Cumulative - first1HourSnapShot_Price0Cumulative;
    ...
    function second1DaySnapShot() public returns (uint224 oneDayTwap) {
        ...
        uint256 lookback = second1DaySnapShot_TimeStamp - first1DaySnapShot_TimeStamp;
        uint256 pricep = second1DaySnapShot_Price0Cumulative - first1DaySnapShot_Price0Cumulative;
